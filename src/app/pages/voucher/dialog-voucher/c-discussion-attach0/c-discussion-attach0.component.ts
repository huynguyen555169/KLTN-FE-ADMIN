...
@Component({
  selector: 'app-c-discussion-attach0',
  templateUrl: './c-discussion-attach0.component.html',
  styleUrls: ['./c-discussion-attach0.component.scss']
})
export class CDiscussionAttach0Component implements OnInit {
  files: any[] = [];
  url = [];
